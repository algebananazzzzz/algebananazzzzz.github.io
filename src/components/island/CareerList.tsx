...
const STELLAR_BY_KEY: Record<string, StellarClass> = {
  protostar: {
    ...
    classDesc: 'collapsing, pre-fusion',
    color: '#dc2626',
  ...
  mainseq: {
    stellarClass: 'Main-sequence star',
    classDesc: 'hydrogen fusion, stable burn',
    color: '#fde047',
  ...
  dwarf: {
    stellarClass: 'Red Dwarf',
    classDesc: 'M-type, low-mass, long-burning',
    color: '#f87171',
  ...
  kmain: {
    stellarClass: 'K-type',
    classDesc: 'orange, steady main-sequence',
    color: '#fdba74',
  ...
  gmain: {
    stellarClass: 'G-type',
    classDesc: 'sun-like, balanced fusion',
    color: '#fde047',
    glow: 'rgba(253, 224, 71, 0.6)',
    sizeMul: 1.05,
    bri: 1.1,
  ...
  bgiant: {
    stellarClass: 'Blue Giant',
    classDesc: 'O-type, hot, luminous',
    color: '#93c5fd',
  ...
  subgiant: {
    stellarClass: 'Subgiant',
    classDesc: 'expanding, fusion shell forming',
    color: '#fbbf24',
  ...
  giant: {
    stellarClass: 'Red Giant',
    classDesc: 'expanded, fusing helium',
    color: '#f87171',
  ...
  whitedwarf: {
    stellarClass: 'White Dwarf',
    classDesc: 'compact ember, cooling',
    color: '#e5e7eb',
  ...
  neutron: {
    stellarClass: 'Neutron Star',
    classDesc: 'collapsed, magnetic pulsar',
    color: '#bae6fd',
    glow: 'rgba(186, 230, 253, 0.95)',
    sizeMul: 0.5,
    bri: 2.0,
  },
  blackhole: {
    stellarClass: 'Black Hole',
    classDesc: 'singular, light-bending',
    color: '#1e1b4b',
